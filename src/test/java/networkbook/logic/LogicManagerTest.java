...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonNetworkBookStorage networkBookStorage =
                new JsonNetworkBookStorage(temporaryFolder.resolve("networkBook.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(networkBookStorage, userPrefsStorage);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonNetworkBookStorage networkBookStorage = new JsonNetworkBookStorage(prefPath) {
            @Override
            public void saveNetworkBook(ReadOnlyNetworkBook networkBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
