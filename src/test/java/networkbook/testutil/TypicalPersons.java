...
public class TypicalPersons {
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhones(List.of("95352563"))
            .withEmails(List.of("heinz@example.com")).build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhones(List.of("87652533"))
            .withEmails(List.of("cornelia@example.com"))
            .withTags("friends").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhones(List.of("9482224"))
            .withEmails(List.of("werner@example.com")).build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhones(List.of("9482427"))
            .withEmails(List.of("lydia@example.com")).build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhones(List.of("9482442"))
    ...
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhones(List.of(VALID_PHONE_BOB))
            ...
            .withCourse(VALID_COURSE_BOB).withSpecialisations(List.of(VALID_SPECIALISATION_BOB))
