...
public class JsonAdaptedDateTest {
    ...
    private static final String INVALID_AVATAR = "10";
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedDate person = new JsonAdaptedDate(null, VALID_AGE, VALID_GENDER, VALID_HEIGHT,
                VALID_INCOME, VALID_HOROSCOPE, VALID_AVATAR);
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        JsonAdaptedDate person =
                new JsonAdaptedDate(VALID_NAME, VALID_AGE, INVALID_GENDER, VALID_HEIGHT, VALID_INCOME,
                        VALID_HOROSCOPE, VALID_AVATAR);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedDate person =
                new JsonAdaptedDate(VALID_NAME, VALID_AGE, VALID_GENDER, INVALID_HEIGHT, VALID_INCOME,
                        VALID_HOROSCOPE, VALID_AVATAR);
    ...
    public void toModelType_invalidHoroscope_throwsIllegalValueException() {
        JsonAdaptedDate person =
                new JsonAdaptedDate(VALID_NAME, VALID_AGE, VALID_GENDER, VALID_HEIGHT, VALID_INCOME, INVALID_HOROSCOPE,
                        VALID_AVATAR);
    ...
    public void toModelType_nullHoroscope_throwsIllegalValueException() {
        JsonAdaptedDate person = new JsonAdaptedDate(VALID_NAME, VALID_AGE, VALID_GENDER, VALID_HEIGHT,
                VALID_INCOME, null, VALID_AVATAR);
