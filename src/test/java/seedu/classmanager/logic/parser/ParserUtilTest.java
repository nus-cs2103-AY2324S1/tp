...
import static seedu.classmanager.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    private static final String INVALID_STUDENT_NUMBER = "T010821J";
    private static final String INVALID_CLASS_NUMBER = "12";
    private static final String INVALID_EMAIL = "example.com";
    private static final String INVALID_TAG = "#friend";

    private static final String VALID_NAME = "Rachel Walker";
    private static final String VALID_PHONE = "123456";
    private static final String VALID_STUDENT_NUMBER = "A0128571A";
    private static final String VALID_CLASS_NUMBER = "T11";
    ...
    public void parseComment_validValueWithoutWhitespace_returnsComment() throws Exception {
        Comment expectedComment = new Comment(VALID_TAG_1);
        assertEquals(expectedComment, ParserUtil.parseComment(VALID_TAG_1));
    }
}
