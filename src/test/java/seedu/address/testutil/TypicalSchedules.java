...
public class TypicalSchedules {
    ...
    public static final Schedule SCHEDULE_ALICE_SECOND_JAN_1 = new ScheduleBuilder()
            .withTutor(TypicalPersons.ALICE)
            .withStartTime(LocalDateTime.of(2023, 1, 2, 9, 0, 0))
            .withEndTime(LocalDateTime.of(2023, 1, 2, 11, 0, 0))
            .build();

    public static final Schedule SCHEDULE_ALICE_SECOND_JAN_2 = new ScheduleBuilder()
            .withTutor(TypicalPersons.ALICE)
    ...
    public static List<Schedule> getTypicalSchedules() {
        return new ArrayList<>(Arrays.asList(SCHEDULE_ALICE_FIRST_JAN, SCHEDULE_ALICE_SECOND_JAN_1,
                SCHEDULE_ALICE_SECOND_JAN_2, SCHEDULE_BOB_SECOND_JAN));
    }
}
