...
public class TypicalPersons {
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            ...
            .withNextOfKinPhone(VALID_NEXT_OF_KIN_PHONE_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withNextOfKinName(VALID_NEXT_OF_KIN_NAME_BOB)
            .withNextOfKinPhone(VALID_NEXT_OF_KIN_PHONE_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
