...
public class TypicalPersons {
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            ...
            .withNextOfKinPhone("94821113").build();
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withNextOfKinName(VALID_NOK_NAME_AMY)
            .withNextOfKinPhone(VALID_NOK_PHONE_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withNextOfKinName(VALID_NOK_NAME_BOB)
            .withNextOfKinPhone(VALID_NOK_PHONE_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND)
            .build();
