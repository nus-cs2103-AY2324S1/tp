...
public class TypicalPersons {
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withBankAccount(VALID_BANKACCOUNT_AMY).withJoinDate(VALID_JOINDATE_AMY)
            .withSalary(VALID_SALARY_AMY).withAnnualLeave(VALID_ANNUALLEAVE_AMY).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withBankAccount(VALID_BANKACCOUNT_BOB).withJoinDate(VALID_JOINDATE_BOB)
            .withSalary(VALID_SALARY_BOB).withAnnualLeave(VALID_ANNUALLEAVE_BOB).build();
