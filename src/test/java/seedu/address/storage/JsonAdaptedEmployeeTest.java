...
public class JsonAdaptedEmployeeTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedEmployee employee =
                new JsonAdaptedEmployee(INVALID_NAME, VALID_POSITION, VALID_PHONE, VALID_EMAIL, VALID_DEPARTMENTS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedEmployee employee = new JsonAdaptedEmployee(null, VALID_POSITION ,VALID_PHONE,
                VALID_EMAIL, VALID_DEPARTMENTS);
    ...
    public void toModelType_invalidPosition_throwsIllegalValueException() {
        JsonAdaptedEmployee employee =
                new JsonAdaptedEmployee(VALID_NAME, INVALID_POSITION, VALID_PHONE, VALID_EMAIL, VALID_DEPARTMENTS);
    ...
    public void toModelType_nullPosition_throwsIllegalValueException() {
        JsonAdaptedEmployee employee = new JsonAdaptedEmployee(VALID_NAME, null, VALID_PHONE,
                VALID_EMAIL, VALID_DEPARTMENTS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedEmployee employee =
                new JsonAdaptedEmployee(VALID_NAME, VALID_POSITION, INVALID_PHONE, VALID_EMAIL, VALID_DEPARTMENTS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedEmployee employee = new JsonAdaptedEmployee(VALID_NAME, VALID_POSITION, null,
                VALID_EMAIL, VALID_DEPARTMENTS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedEmployee employee =
                new JsonAdaptedEmployee(VALID_NAME, VALID_POSITION, VALID_PHONE, INVALID_EMAIL, VALID_DEPARTMENTS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedEmployee employee = new JsonAdaptedEmployee(VALID_NAME, VALID_POSITION, VALID_PHONE,
                null, VALID_DEPARTMENTS);
    ...
    public void toModelType_invalidDepartments_throwsIllegalValueException() {
        ...
        JsonAdaptedEmployee employee =
                new JsonAdaptedEmployee(VALID_NAME, VALID_POSITION, VALID_PHONE, VALID_EMAIL, invalidDepartments);
