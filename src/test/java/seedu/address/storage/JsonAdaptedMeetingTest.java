...
public class JsonAdaptedMeetingTest {
    ...
    private static final Meeting EDITED_MEETING_1 = new MeetingBuilder(MEETING1)
            .withAttendees("Alice Pauline").build();
    ...
    public void toModelType_invalidTitle_throwsIllegalValueException() throws IllegalValueException {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(INVALID_TITLE, VALID_LOCATION, VALID_START,
                        VALID_END, VALID_ATTENDEE);
    ...
    public void toModelType_nullTitle_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting = new JsonAdaptedMeeting(null, VALID_LOCATION, VALID_START,
                VALID_END, VALID_ATTENDEE);
    ...
    public void toModelType_invalidLocation_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, INVALID_LOCATION, VALID_START, VALID_END, VALID_ATTENDEE);
    ...
    public void toModelType_nullLocation_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting = new JsonAdaptedMeeting(VALID_TITLE, null, VALID_START,
                VALID_END, VALID_ATTENDEE);
    ...
    public void toModelType_invalidStart_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, VALID_LOCATION, INVALID_START, VALID_END, VALID_ATTENDEE);
    ...
    public void toModelType_nullStart_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting = new JsonAdaptedMeeting(VALID_TITLE, VALID_LOCATION, null,
                VALID_END, VALID_ATTENDEE);
    ...
    public void toModelType_invalidEnd_throwsIllegalValueException() {
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, VALID_LOCATION, VALID_START, INVALID_END, VALID_ATTENDEE);
        String expectedMessage = MeetingTime.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, meeting::toModelType);
    }
    ...
    public void toModelType_invalidAttendees_throwsIllegalValueException() {
        ...
        JsonAdaptedMeeting meeting =
                new JsonAdaptedMeeting(VALID_TITLE, VALID_LOCATION, VALID_START, VALID_END, invalidAttendees);
