...
public class JsonAdaptedContactTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(null, VALID_PHONE, VALID_EMAIL, VALID_NOTE, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_NAME, null, VALID_EMAIL, VALID_NOTE, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedContact person = new JsonAdaptedContact(VALID_NAME, VALID_PHONE, null, VALID_NOTE, VALID_TAGS);
