...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedEvent> VALID_EVENTS = BENSON.getEventList().stream()
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_EVENTS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_EVENTS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS, VALID_EVENTS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS, VALID_EVENTS);
    ...
    @Test
    public void toModelType_invalidEvents_throwsIllegalValueException() {
        List<JsonAdaptedEvent> invalidEvents = new ArrayList<>(VALID_EVENTS);
        invalidEvents.add(new JsonAdaptedEvent(INVALID_DESCRIPTION, INVALID_EVENT_PERIOD));
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, invalidEvents);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
