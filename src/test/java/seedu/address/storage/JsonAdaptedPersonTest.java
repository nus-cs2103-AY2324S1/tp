...
public class JsonAdaptedPersonTest {
    ...
    private static final String INVALID_NOK_NAME = "R@chel";
    private static final String INVALID_NOK_PHONE = "+651234";
    ...
    private static final String VALID_NOK_NAME = BENSON.getNextOfKinName().toString();
    private static final String VALID_NOK_PHONE = BENSON.getNextOfKinPhone().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_NOK_NAME, VALID_NOK_PHONE, VALID_TAGS);
    ...
    public void toModelType_invalidNextOfKinName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_NOK_NAME, VALID_NOK_PHONE, VALID_TAGS);
    ...
    public void toModelType_nullNextOfKinName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                null, VALID_NOK_PHONE, VALID_TAGS);
    ...
    public void toModelType_invalidNextOfKinPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_NOK_NAME, INVALID_NOK_PHONE, VALID_TAGS);
    ...
    public void toModelType_nullNextOfKinPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_NOK_NAME, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_NOK_NAME, VALID_NOK_PHONE, invalidTags);
