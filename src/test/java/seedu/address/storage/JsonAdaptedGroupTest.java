...
public class JsonAdaptedGroupTest {
    ...
    private static final String VALID_REMARK = CS2100.getGroupRemark().toString();
    ...
    public void toModelType_nullGroupName_throwsIllegalValueException() {
        ...
        String expectedMessage = String.format(JsonAdaptedGroup.MISSING_FIELD_MESSAGE_FORMAT, Group.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, group::toModelType);
    }
    ...
    public void toModelType_invalidGroupRemark_throwsIllegalValueException() {
        ...
        String expectedMessage = String.format(JsonAdaptedGroup.MISSING_FIELD_MESSAGE_FORMAT, GroupRemark.class.getSimpleName());
        assertThrows(IllegalValueException.class, expectedMessage, group::toModelType);
    }
