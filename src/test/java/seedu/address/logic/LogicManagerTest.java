...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonManageHrStorage addressBookStorage =
                new JsonManageHrStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + SALARY_DESC_AMY + LEAVE_DESC_AMY + ROLE_DESC_AMY;
