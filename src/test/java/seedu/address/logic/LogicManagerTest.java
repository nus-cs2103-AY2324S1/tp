...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        JsonAddressBookStorage prevAddressBookStorage =
                new JsonAddressBookStorage(temporaryFolder.resolve("prev.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(addressBookStorage, prevAddressBookStorage, userPrefsStorage);
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteCommand = "delete S9999993Z";
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        JsonAddressBookStorage prevAddressBookStorage = new JsonAddressBookStorage(
                temporaryFolder.resolve("prev.json"));
        ...
        // Triggers the saveAddressBook method by executing an add patient command
        String addCommand = AddPatientCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + CONDITION_DESC_AMY
                + EMERGENCY_CONTACT_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NRIC_DESC_AMY + GENDER_DESC_FEMALE
                + BLOODTYPE_DESC_AMY;
