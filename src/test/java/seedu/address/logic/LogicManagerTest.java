...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteTutorCommand = "delete-t 9";
        assertCommandException(deleteTutorCommand, MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
    }

    @Test
    public void execute_validCommand_success() throws Exception {
        String listTutorCommand = ListTutorCommand.COMMAND_WORD;
        assertCommandSuccess(listTutorCommand, ListTutorCommand.MESSAGE_SUCCESS, model);
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addTutorCommand = AddTutorCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY;
