...
import static seedu.address.logic.Messages.MESSAGE_INVALID_PERSON_DETAILS;
...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteCommand = "delete abc";
        assertCommandException(deleteCommand, MESSAGE_INVALID_PERSON_DETAILS);
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                ...
                + SEC_LEVEL_DESC_AMY + NEAREST_MRT_STATION_DESC_AMY;
