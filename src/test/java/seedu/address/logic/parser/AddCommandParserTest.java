...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresentPatient_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + TAG_DESC_FRIEND + MEDICAL_HISTORY_DESC_AMY,
        ...
        assertParseSuccess(parser,
                NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_HUSBAND
                        + TAG_DESC_FRIEND + MEDICAL_HISTORY_DESC_AMY,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        System.out.println(NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + MEDICAL_HISTORY_DESC_AMY);
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + MEDICAL_HISTORY_DESC_AMY,
