...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB).withTags(VALID_RISK_LEVEL_LOW).build();

        // whitespace only preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + RISK_DESC_LOW, new AddCommand(expectedPerson));


        // multiple tags - change to only accept one tag?
        // Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_RISK_LEVEL_LOW)
        //          .build();
        //   assertParseSuccess(parser,
        // NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + RISK_DESC_LOW + RISK_DESC_HIGH,
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB
                + RISK_DESC_LOW + RISK_DESC_HIGH, Email.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_TAG_DESC + VALID_RISK_LEVEL_LOW, RiskLevel.MESSAGE_CONSTRAINTS);
