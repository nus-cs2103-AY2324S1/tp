...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + DEPARTMENT_DESC_HUSBAND + DEPARTMENT_DESC_FRIEND,
    ...
    public void parse_repeatedNonDepartmentValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedEmployeeString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY
