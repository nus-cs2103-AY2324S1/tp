...
import static seedu.address.logic.commands.CommandTestPersonData.EMAIL_DESC_BOB;
import static seedu.address.logic.commands.CommandTestPersonData.INVALID_EMAIL_DESC;
import static seedu.address.logic.commands.CommandTestPersonData.INVALID_NAME_DESC;
import static seedu.address.logic.commands.CommandTestPersonData.INVALID_PHONE_DESC;
import static seedu.address.logic.commands.CommandTestPersonData.INVALID_TAG_DESC;
import static seedu.address.logic.commands.CommandTestPersonData.NAME_DESC_AMY;
import static seedu.address.logic.commands.CommandTestPersonData.NAME_DESC_BOB;
import static seedu.address.logic.commands.CommandTestPersonData.NOTE_DESC_AMY;
import static seedu.address.logic.commands.CommandTestPersonData.NOTE_DESC_BOB;
import static seedu.address.logic.commands.CommandTestPersonData.PHONE_DESC_AMY;
import static seedu.address.logic.commands.CommandTestPersonData.PHONE_DESC_BOB;
import static seedu.address.logic.commands.CommandTestPersonData.PREAMBLE_NON_EMPTY;
import static seedu.address.logic.commands.CommandTestPersonData.PREAMBLE_WHITESPACE;
import static seedu.address.logic.commands.CommandTestPersonData.TAG_DESC_FRIEND;
import static seedu.address.logic.commands.CommandTestPersonData.TAG_DESC_HUSBAND;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + NOTE_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
