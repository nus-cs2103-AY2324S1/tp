...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + NOK_NAME_DESC_BOB + NOK_PHONE_DESC_BOB + TAG_DESC_FRIEND,
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + NOK_NAME_DESC_BOB
                        + NOK_PHONE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_repeatedNonTagValue_failure() {
        ...
        assertParseFailure(parser, NOK_NAME_DESC_AMY + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NOK_NAME));
        // multiple nextOfKinPhones
        assertParseFailure(parser, NOK_PHONE_DESC_AMY + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NOK_PHONE));
        ...
        assertParseFailure(parser,
                ...
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ADDRESS, PREFIX_EMAIL, PREFIX_PHONE,
                        PREFIX_NOK_NAME, PREFIX_NOK_PHONE));
        ...
        assertParseFailure(parser, INVALID_NOK_NAME_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NOK_NAME));
        // invalid nextOfKinPhone
        assertParseFailure(parser, INVALID_NOK_PHONE_DESC + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NOK_PHONE));
        ...
        assertParseFailure(parser, validExpectedPersonString + INVALID_ADDRESS_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_ADDRESS));
        // invalid nextOfKinName
        assertParseFailure(parser, validExpectedPersonString + INVALID_NOK_NAME_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NOK_NAME));

        // invalid nextOfKinPhone
        assertParseFailure(parser, validExpectedPersonString + INVALID_NOK_PHONE_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NOK_PHONE));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + NOK_NAME_DESC_BOB + NOK_PHONE_DESC_BOB,
                expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + VALID_NOK_NAME_BOB + NOK_PHONE_DESC_BOB,
                expectedMessage);

        // missing nextOfKinPhone prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + NOK_NAME_DESC_BOB + VALID_NOK_PHONE_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
                + VALID_NOK_NAME_BOB + VALID_NOK_PHONE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid nextOfKinName
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_NOK_NAME_DESC + NOK_PHONE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, NextOfKinName.MESSAGE_CONSTRAINTS);

        // invalid nextOfKinPhone
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + NOK_NAME_DESC_BOB + INVALID_NOK_PHONE_DESC
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + NOK_NAME_DESC_BOB + NOK_PHONE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
