...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                ...
                + ROLE_DESC_BOB + MANAGER_DESC_AMY + DEPARTMENT_DESC_INVESTMENT,
        ...
        assertParseSuccess(parser,
                ...
                + LEAVE_DESC_BOB + ROLE_DESC_BOB + MANAGER_DESC_AMY
    ...
    public void parse_repeatedNonDepartmentValue_failure() {
        ...
        assertParseFailure(parser,
                validExpectedEmployeeString + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
                        + SALARY_DESC_AMY + LEAVE_DESC_AMY + ROLE_DESC_AMY + validExpectedEmployeeString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_NAME, PREFIX_ADDRESS, PREFIX_EMAIL,
                        PREFIX_SALARY, PREFIX_LEAVE, PREFIX_PHONE, PREFIX_ROLE));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_AMY
                + SALARY_DESC_AMY + LEAVE_DESC_AMY + ROLE_DESC_AMY, new AddCommand(expectedEmployee));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SALARY_DESC_BOB + LEAVE_DESC_BOB + ROLE_DESC_BOB
                + MANAGER_DESC_AMY + DEPARTMENT_DESC_LOGISTIC + DEPARTMENT_DESC_INVESTMENT,
        ...
        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_ADDRESS_DESC + SALARY_DESC_BOB + LEAVE_DESC_BOB + ROLE_DESC_BOB + MANAGER_DESC_AMY
                + DEPARTMENT_DESC_LOGISTIC + DEPARTMENT_DESC_INVESTMENT, Address.MESSAGE_CONSTRAINTS);

        // invalid salary
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INVALID_SALARY_DESC + LEAVE_DESC_BOB + ROLE_DESC_BOB + MANAGER_DESC_AMY
                + DEPARTMENT_DESC_LOGISTIC + DEPARTMENT_DESC_INVESTMENT, Salary.MESSAGE_CONSTRAINTS);

        // invalid leave
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SALARY_DESC_BOB + INVALID_LEAVE_DESC + ROLE_DESC_BOB + MANAGER_DESC_AMY
                + DEPARTMENT_DESC_LOGISTIC + DEPARTMENT_DESC_INVESTMENT, Leave.MESSAGE_CONSTRAINTS);

        // invalid role
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SALARY_DESC_BOB + LEAVE_DESC_BOB + INVALID_ROLE_DESC + MANAGER_DESC_AMY
                + DEPARTMENT_DESC_LOGISTIC + DEPARTMENT_DESC_INVESTMENT, Role.MESSAGE_CONSTRAINTS);

        // invalid department
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + SALARY_DESC_BOB + LEAVE_DESC_BOB + ROLE_DESC_BOB + MANAGER_DESC_AMY
                + INVALID_DEPARTMENT_DESC + VALID_DEPARTMENT_INVESTMENT, DepartmentName.MESSAGE_CONSTRAINTS);

        // two invalid values, only first invalid value reported
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ROLE_DESC_BOB + MANAGER_DESC_AMY
                + INVALID_ADDRESS_DESC + SALARY_DESC_BOB + LEAVE_DESC_BOB, EmployeeName.MESSAGE_CONSTRAINTS);
