...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DEPARTMENT_DESC_INVESTMENT, new AddCommand(expectedPerson));


        // multiple departments - all accepted
        Person expectedPersonMultipleDepartments = new PersonBuilder(BOB).withDepartments(VALID_DEPARTMENT_INVESTMENT, VALID_DEPARTMENT_LOGISTIC)
                .build();
        assertParseSuccess(parser,
                NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DEPARTMENT_DESC_LOGISTIC + DEPARTMENT_DESC_INVESTMENT,
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DEPARTMENT_DESC_INVESTMENT;
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DEPARTMENT_DESC_LOGISTIC + DEPARTMENT_DESC_INVESTMENT,
