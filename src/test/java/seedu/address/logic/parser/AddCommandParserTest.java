...
public class AddCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GENDER_DESC_BOB + SEC_LEVEL_DESC_BOB + NEAREST_MRT_STATION_DESC_BOB
                + SUBJECT_DESC_MATHEMATICS + SUBJECT_DESC_PHYSICS, Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + GENDER_DESC_BOB + SEC_LEVEL_DESC_BOB + NEAREST_MRT_STATION_DESC_BOB
                + SUBJECT_DESC_MATHEMATICS + SUBJECT_DESC_PHYSICS, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC
                + ADDRESS_DESC_BOB + GENDER_DESC_BOB + SEC_LEVEL_DESC_BOB + NEAREST_MRT_STATION_DESC_BOB
                + SUBJECT_DESC_MATHEMATICS + SUBJECT_DESC_PHYSICS, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + INVALID_ADDRESS_DESC + GENDER_DESC_BOB + SEC_LEVEL_DESC_BOB + NEAREST_MRT_STATION_DESC_BOB
                + SUBJECT_DESC_MATHEMATICS + SUBJECT_DESC_PHYSICS, Address.MESSAGE_CONSTRAINTS);

        // invalid gender
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + INVALID_GENDER_DESC + SEC_LEVEL_DESC_BOB + NEAREST_MRT_STATION_DESC_BOB
                + SUBJECT_DESC_MATHEMATICS + SUBJECT_DESC_PHYSICS, Gender.MESSAGE_CONSTRAINTS);

        // invalid secLevel
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GENDER_DESC_BOB + INVALID_SEC_LEVEL_DESC + NEAREST_MRT_STATION_DESC_BOB
                + SUBJECT_DESC_MATHEMATICS + SUBJECT_DESC_PHYSICS, SecLevel.MESSAGE_CONSTRAINTS);

        // invalid nearestMrtStation
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + GENDER_DESC_BOB + SEC_LEVEL_DESC_BOB + INVALID_NEAREST_MRT_STATION_DESC
                + SUBJECT_DESC_MATHEMATICS + SUBJECT_DESC_PHYSICS, MrtStation.MESSAGE_CONSTRAINTS);
