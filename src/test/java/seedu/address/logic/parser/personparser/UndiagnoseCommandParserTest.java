...
public class UndiagnoseCommandParserTest {

    private static final String TAG_EMPTY = " " + PREFIX_ILLNESSES;

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, UndiagnoseCommand.MESSAGE_USAGE);

    private UndiagnoseCommandParser parser = new UndiagnoseCommandParser();
    @Test
    ...
    public void parse_allFieldsSpecifiedOneIllness_success() {
        ...
        UndiagnoseCommand expectedCommand = new UndiagnoseCommand(targetIndex, createTypicalIllnessSet());
    ...
    public void parse_allFieldsSpecifiedMultipleIllnesses_success() {
        ...
        UndiagnoseCommand expectedCommand = new UndiagnoseCommand(targetIndex, createTypicalIllnessesSet());
