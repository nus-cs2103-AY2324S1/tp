...
public class FindCommandParserTest {
    ...
    public void parse_singlePrefixGivenNoValue_throwsParseException() {
        ...
        assertParseFailure(parser, " n/", String.format(MESSAGE_EMPTY_FIELDS, "n/"));
        assertParseFailure(parser, " l/", String.format(MESSAGE_EMPTY_FIELDS, "l/"));
        assertParseFailure(parser, " i/", String.format(MESSAGE_EMPTY_FIELDS, "i/"));
        assertParseFailure(parser, " p/", String.format(MESSAGE_EMPTY_FIELDS, "p/"));
        assertParseFailure(parser, " t/", String.format(MESSAGE_EMPTY_FIELDS, "t/"));
        assertParseFailure(parser, " e/", String.format(MESSAGE_EMPTY_FIELDS, "e/"));
        assertParseFailure(parser, " c/", String.format(MESSAGE_EMPTY_FIELDS, "c/"));
        assertParseFailure(parser, " pn/", String.format(MESSAGE_EMPTY_FIELDS, "pn/"));
        assertParseFailure(parser, " pi/", String.format(MESSAGE_EMPTY_FIELDS, "pi/"));
        assertParseFailure(parser, " pe/", String.format(MESSAGE_EMPTY_FIELDS, "pe/"));
    }

    @Test
    public void parse_multiplePrefixGivenAllNoValue_throwsParseException() {
        // All prefixes no value
        assertParseFailure(parser, " n/ l/", String.format(MESSAGE_EMPTY_FIELDS, "n/ l/"));
        assertParseFailure(parser, " n/ c/", String.format(MESSAGE_EMPTY_FIELDS, "n/ c/"));
        assertParseFailure(parser, " i/ p/", String.format(MESSAGE_EMPTY_FIELDS, "i/ p/"));
    }

    @Test
    public void parse_multiplePrefixSomeHasValue_throwsParseException() {
        // Some prefix has value
        assertParseFailure(parser, " n/Alice l/", String.format(MESSAGE_EMPTY_FIELDS, "l/"));
        assertParseFailure(parser, " n/ c/Google", String.format(MESSAGE_EMPTY_FIELDS, "n/"));
        assertParseFailure(parser, " i/589J p/ pi/01-01-2024", String.format(MESSAGE_EMPTY_FIELDS, "p/"));
        assertParseFailure(parser, " p/98765432 l/SLA e/ n/", String.format(MESSAGE_EMPTY_FIELDS, "n/ e/"));
    }
