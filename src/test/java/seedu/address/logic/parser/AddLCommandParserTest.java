...
public class AddLCommandParserTest {
    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddLCommand.MESSAGE_USAGE);
    private AddLCommandParser parser = new AddLCommandParser();
    ...
    public void parse_indexSpecified_success() {
        ...
        AddLCommand expectedCommand = new AddLCommand(INDEX_FIRST_PERSON, new LinkedIn(nonEmptyUsername));
        assertParseSuccess(parser, userInput, expectedCommand);

        userInput = targetIndex.getOneBased() + " " + PREFIX_USERNAME;
        expectedCommand = new AddLCommand(INDEX_FIRST_PERSON, new LinkedIn(""));
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_missingCompulsoryField_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddLCommand.MESSAGE_USAGE);

        // no parameters
        assertParseFailure(parser, AddLCommand.COMMAND_WORD, expectedMessage);
