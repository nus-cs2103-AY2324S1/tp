...
import static seedu.address.logic.commands.CommandTestUtil.LASTTIME_DESC_AMY;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + LASTTIME_DESC_AMY + STATUS_DESC_AMY + REMARK_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withLastContactedTime(VALID_LASTTIME_AMY).withStatus(VALID_STATUS_AMY)
                .withRemark(REMARK_DESC_AMY).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
