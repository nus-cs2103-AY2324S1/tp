...
public class EditCommandParserTest {
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        assertParseSuccess(
                parser,
                PREAMBLE_WHITESPACE + "3" + " "
                        + PREFIX_TELEGRAM + "@telegram" + " ", expectedCommand);
        ...
        assertParseSuccess(
                parser,
                PREAMBLE_WHITESPACE + "3" + " "
                        + PREFIX_SECONDARY_EMAIL + "email@email.com" + " ", expectedCommand);
        ...
        assertParseSuccess(
                parser,
                PREAMBLE_WHITESPACE + "3" + " "
                        + PREFIX_LINKEDIN + "LINKEDIN" + " ", expectedCommand);
        ...
        assertParseSuccess(
                parser,
                PREAMBLE_WHITESPACE + "3" + " "
                        + PREFIX_BIRTHDAY + "09/06", expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                ...
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + TAG_DESC_HUSBAND + " li/amy" + " li/bob"
                + " b/31/07" + " b/31/05" + " e2/amy@hotmail.com" + " e2/bob@hotmail.com" + " tg/@amyyy" + " tg/@bobbb";

        assertParseFailure(parser, userInput,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                        PREFIX_BIRTHDAY, PREFIX_SECONDARY_EMAIL, PREFIX_LINKEDIN, PREFIX_TELEGRAM));
