...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + RISK_DESC_LOW
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + RISK_DESC_HIGH;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // tags
        userInput = targetIndex.getOneBased() + RISK_DESC_HIGH;
        descriptor = new EditPersonDescriptorBuilder().withTags(VALID_RISK_LEVEL_HIGH).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                + RISK_DESC_HIGH + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY + RISK_DESC_HIGH
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + RISK_DESC_LOW;
