...
public class CommandTestUtil {
    ...
    public static final String INVALID_ID_DESC = " " + PREFIX_ID + "ID1234-5678"; // empty string not allowed for ids
    ...
    public static void showEmployeeAtIndex(Model model, Index targetIndex) {
        ...
        model.updateFilteredEmployeeList(new EmployeeContainsKeywordsPredicate(Arrays.asList(splitName[0])));
