...
import seedu.address.testutil.NameContainsKeywordsPredicate;
...
public class CommandTestUtil {
    ...
    public static final String VALID_STUDENTNUMBER_AMY = "A0218510F";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withStudentNumber(VALID_STUDENTNUMBER_AMY)
                .withClassNumber(VALID_CLASSNUMBER_AMY).withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withStudentNumber(VALID_STUDENTNUMBER_BOB)
                .withClassNumber(VALID_CLASSNUMBER_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
    }
