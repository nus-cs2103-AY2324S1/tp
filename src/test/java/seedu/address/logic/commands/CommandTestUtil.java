...
public class CommandTestUtil {
    ...
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_BOOKING_PERIOD + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_BOOKING_PERIOD + VALID_ADDRESS_BOB;
    ...
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_BOOKING_PERIOD; // empty string not allowed for addresses
