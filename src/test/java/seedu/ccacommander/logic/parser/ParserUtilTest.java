...
import static seedu.ccacommander.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    private static final String INVALID_DATE = "2020 10 12";
    ...
    private static final String VALID_LOCATION = "Home";
    private static final String VALID_DATE = "2005-12-12";
    ...
    @Test
    public void parseEventDate_validValueWithoutWhitespace_returnsAddress() throws Exception {
        EventDate expectedEventDate = new EventDate(VALID_DATE);
        assertEquals(expectedEventDate, ParserUtil.parseEventDate(VALID_DATE));
    }

    @Test
    public void parseEventDate_validValueWithWhitespace_returnsTrimmedAddress() throws Exception {
        String dateWithWhitespace = WHITESPACE + VALID_DATE + WHITESPACE;
        EventDate expectedEventDate = new EventDate(VALID_DATE);
        assertEquals(expectedEventDate, ParserUtil.parseEventDate(dateWithWhitespace));
    }
}
