...
public class ViewCommandTest {
    ...
    @BeforeEach
    public void setUp() {
        model = new ModelManager(getTypicalAddressBook(), getTypicalRecordBook(), new UserPrefs());
        expectedModel = new ModelManager(model.getAddressBook(), model.getRecordBook(), new UserPrefs());
    }
