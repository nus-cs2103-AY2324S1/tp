...
public class MainWindow extends UiPart<Stage> {
    ...
    private void setAccelerator(MenuItem menuItem, KeyCombination keyCombination) {
         ...
         * report, TextInputControl (TextField, TextArea) will consume function-key events. Because CommandBox
         * contains a TextField, and ResultDisplay contains a TextArea, thus some accelerators (e.g F1) will not work
         * when the focus is in them because the key event is consumed by the TextInputControl(s). For now, we add
         * following event filter to capture such key events and open help window purposely so to support accelerators
         * even when focus is in CommandBox or ResultDisplay.
         */
    ...
    private CommandResult executeCommand(String commandText) throws CommandException, ParseException {
        try {
            ...
            int interviewIndex = commandResult.interviewIndex();
            if (interviewIndex >= 0) {
