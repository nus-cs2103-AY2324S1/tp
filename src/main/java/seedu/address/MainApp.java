...
import seedu.address.storage.ManageHrStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing ManageHR ]===========================");
        super.init();
        ...
        ManageHrStorage manageHrStorage = new JsonManageHrStorage(userPrefs.getManageHrFilePath());
        storage = new StorageManager(manageHrStorage, userPrefsStorage);
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting ManageHR " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping ManageHR ] =============================");
        try {
