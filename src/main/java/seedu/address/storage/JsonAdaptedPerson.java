...
class JsonAdaptedPerson {
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        if (name == null) {
            throw new IllegalValueException(String.format(PERSON_MISSING_FIELD_MESSAGE_FORMAT, Name.class.getSimpleName()));
        }
        ...
        if (phone == null) {
            throw new IllegalValueException(String.format(PERSON_MISSING_FIELD_MESSAGE_FORMAT, Phone.class.getSimpleName()));
        }
        ...
        if (email == null) {
            throw new IllegalValueException(String.format(PERSON_MISSING_FIELD_MESSAGE_FORMAT, Email.class.getSimpleName()));
        }
        ...
        if (address == null) {
            throw new IllegalValueException(String.format(PERSON_MISSING_FIELD_MESSAGE_FORMAT, Address.class.getSimpleName()));
        }
