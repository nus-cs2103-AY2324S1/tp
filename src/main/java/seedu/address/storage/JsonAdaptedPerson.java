...
abstract class JsonAdaptedPerson {
    ...
    public String getName() throws IllegalValueException {
        if (name == null) {
    ...
    public String getPhone() throws IllegalValueException {
        if (phone == null) {
    ...
    public String getEmail() throws IllegalValueException {
        if (email == null) {
