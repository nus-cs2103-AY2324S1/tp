...
import static seedu.address.logic.Messages.MESSAGE_INVALID_APPOINTMENT_SORT_ATTRIBUTE;
...
public class SortCommandParser implements Parser<SortCommand> {
    ...
    public SortCommand parse(String args) throws ParseException {
        ...
        if (Arrays.stream(ATTRIBUTES).noneMatch(x -> x.equals(attribute))) {
            throw new ParseException(String.format(MESSAGE_INVALID_APPOINTMENT_SORT_ATTRIBUTE,
