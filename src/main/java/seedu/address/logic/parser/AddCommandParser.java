...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        NextOfKinName nokName = ParserUtil.parseNextOfKinName(argMultimap.getValue(PREFIX_NOK_NAME).get());
        NextOfKinPhone nokPhone = ParserUtil.parseNextOfKinPhone((argMultimap.getValue(PREFIX_NOK_PHONE)).get());
