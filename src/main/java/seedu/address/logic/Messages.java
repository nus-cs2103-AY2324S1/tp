...
public class Messages {
    ...
    public static final String MESSAGE_TAG_DOES_NOT_EXIST = "The tag does not exist";
    public static final String MESSAGE_ILLEGAL_TAG_SCORE = "The tag does not exist, cannot attach a score to it";
