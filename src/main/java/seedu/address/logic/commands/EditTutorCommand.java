...
public class EditTutorCommand extends Command {
     ...
     */
    public EditTutorCommand(Index index, EditPersonDescriptor editPersonDescriptor) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof EditTutorCommand)) {
            return false;
        }

        EditTutorCommand otherEditTutorCommand = (EditTutorCommand) other;
        return index.equals(otherEditTutorCommand.index)
                && editPersonDescriptor.equals(otherEditTutorCommand.editPersonDescriptor);
    }
