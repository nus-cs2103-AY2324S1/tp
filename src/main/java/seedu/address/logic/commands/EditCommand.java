...
public class EditCommand extends Command {
    ...
    private static Employee createEditedEmployee(
        ...
        return new Employee(updatedName, updatedPhone, updatedDepartment, updatedAddress, updatedTags);
    }
    ...
    public static class EditEmployeeDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, department, address, tags);
        }
