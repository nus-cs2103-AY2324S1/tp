...
public class ID {
    ...
    public static final String MESSAGE_CONSTRAINTS = "IDs should only contain alphanumeric characters, with no "
            + "special characters or space, and it should not be blank";
