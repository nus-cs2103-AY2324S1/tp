 ...
 * A person is considered unique by comparing using {@code Student#isSamePerson(Student)}. As such, adding and updating
 * of persons uses Student#isSamePerson(Student) for equality to ensure that the person being added or updated is
 * unique in terms of identity in the UniqueStudentList. However, the removal of a person uses Student#equals(Object) so
...
public class UniqueStudentList implements Iterable<Student> {
    ...
    public void setPerson(Student target, Student editedPerson) {
        ...
        if (!target.isSameStudent(editedPerson) && contains(editedPerson)) {
            throw new DuplicateStudentException();
        }
    ...
    public boolean equals(Object other) {
        ...
        UniqueStudentList otherUniquePersonList = (UniqueStudentList) other;
