    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
                ...
                new Person.PersonBuilder(new Name("Oliver Ho"), new Phone("94321678"),
                        ...
                        .withLead(new Lead("WARM"))
                        .addInteraction(new Interaction(
                                "Asked for CRM features", Interaction.Outcome.valueOf("INTERESTED"),
                                LocalDate.of(2023, 10, 15)
                        ))
                        .addInteraction(new Interaction(
                                "Requested a pricing plan", Interaction.Outcome.valueOf("FOLLOWUP_REQUIRED"),
                ...
                new Person.PersonBuilder(new Name("Harper Lee"), new Phone("92234567"),
                        new
                                ...
                                Email("harperl@example.com"), new Address("Blk 12 Kent Ridge Drive #14-06"),
                        getTagSet("schoolmate"))
