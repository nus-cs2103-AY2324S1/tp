 ...
 * cards uses Card#isSameCard(Card) for equality to ensure that the card being added or updated is
 * unique in terms of identity in the UniqueCardList. However, the removal of a card uses Card#equals(Object)
