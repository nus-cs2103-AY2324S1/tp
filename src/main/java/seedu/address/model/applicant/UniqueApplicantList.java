 ...
 * An applicant is considered unique by comparing using {@code Applicant#isSameApplicant(Applicant)}.
 * As such, adding and updating of applicants uses Applicant#isSameApplicant(Applicant) for equality
 * so as to ensure that the applicant being added or updated is unique in terms of identity in the
 * UniqueApplicantList. However, the removal of a applicant uses Applicant#equals(Object) so
