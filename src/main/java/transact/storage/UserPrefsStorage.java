...
/**
 * Represents a storage for {@link transact.model.UserPrefs}.
 */
public interface UserPrefsStorage {
     ...
     *             if the loading of data from preference file
     *             failed.
     */
    Optional<UserPrefs> readUserPrefs() throws DataLoadingException;

    /**
     * Saves the given {@link transact.model.ReadOnlyUserPrefs} to the storage.
     *
     * @param userPrefs
     *            cannot be null.
     * @throws IOException
