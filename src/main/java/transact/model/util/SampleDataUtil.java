    ...
    public static Transaction[] getSampleTransactions() {
        return new Transaction[] {
            new Transaction(TransactionType.EXPENSE, new Description("Expense 1"), new Amount(100),
                    new Date("11/11/2023"), 1),
            new Transaction(TransactionType.EXPENSE, new Description("Expense 2"), new Amount(200),
                    new Date("11/11/2023"), 2),
            new Transaction(TransactionType.EXPENSE, new Description("Expense 3"), new Amount(300),
                    new Date("11/11/2023"), 3),
            new Transaction(TransactionType.REVENUE, new Description("Revenue 1"), new Amount(1000),
                    new Date("11/11/2023"), 4),
            new Transaction(TransactionType.REVENUE, new Description("Revenue 2"), new Amount(1200),
                    new Date("11/11/2023"), 5),
            new Transaction(TransactionType.REVENUE, new Description("Profit"), new Amount(1200),
                    new Date("01/01/2023"), 1),
            new Transaction(TransactionType.REVENUE, new Description("Profit"), new Amount(100),
                    new Date("01/02/2023"), -1),
            new Transaction(TransactionType.REVENUE, new Description("Profit"), new Amount(1400),
                    new Date("01/03/2023"), 3),
            new Transaction(TransactionType.REVENUE, new Description("Profit"), new Amount(88),
                    new Date("01/04/2023"), -1),
            new Transaction(TransactionType.REVENUE, new Description("Profit"), new Amount(250),
                    new Date("01/05/2023"), 5),
            new Transaction(TransactionType.REVENUE, new Description("Profit"), new Amount(600),
                    new Date("01/06/2023"), -1),
