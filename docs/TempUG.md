...
| Flag                           | Used in                                                            | Argument constraints                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Valid inputs                                                                                                 | Invalid inputs                    |
|--------------------------------|--------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|-----------------------------------|
| **-name**                      | `addLesson` `editLesson`<br/>`addPerson` `editPerson`<br/>`filter` | Must not be empty. <br/>Must only contain alphanumeric characters (only for `addPerson` and `editPerson`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | "John", "Elton"                                                                                              | "", "jo!"                         |   
...
| **-tag**                       | `addPerson` `editPerson`                                           | Must not be empty and cannot contain any spaces. Multiple tags can be specified at once by using a comma (,) as a separator.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | "jc,express", "weak"                                                                                         | "junior college"                  |
| **-start<br/>-end**            | `addLesson` `editLesson`                                           | Must follow either the date format **yyyy/MM/dd**, *yy/MM/dd*, **MM/dd**, **dd**. See [here](https://www.unicode.org/reports/tr35/tr35-dates.html#Date_Field_Symbol_Table) for an exhaustive explanation of the allowable formats.                                                                                                                                                                                                                                                                                                                                                                                                  | To represent the date 13/08/2023 and assuming it is 07/08/2023: <br/>"2023/08/13", "23/08/13", "08/13", "13" | "20222/08/2", "13/1"              |          
| **-before<br/>-on<br/>-after** | `filter`                                                           | Same as above (-start, -end)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Same as above (-start, -end)                                                                                 | Same as above <br/>(-start, -end) | 
