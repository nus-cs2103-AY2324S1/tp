...
| `REMARK`                              | `addPerson` `editPerson`                                                               | Must be alphanumeric. Can be empty                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | "Bedok", "25 Lower Kent Ridge Road", ""                                                                         | "📅"                        |
...
| **Filter**   | Schedule                            | `filter [-name NAME] [-subject SUBJECTS] [-before DATE] [-on DATE] [-after DATE]`                                        | `filter -before 2023/12/20 -subject Mathematics`                                                                  | NA                                                                           |
