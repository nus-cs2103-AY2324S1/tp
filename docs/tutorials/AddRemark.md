...
```java
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Edits the remark of the date identified "
            + "by the index number used in the last date listing. "
...
public class RemarkCommand extends Command {
    ...
    /**
     * @param index of the date in the filtered date list to edit the remark
     * @param remark of the date to be updated to
     */
...
Simply add the following to [`seedu.lovebook.ui.PersonCard`](https://github.com/se-edu/addressbook-level3/commit/850b78879582f38accb05dd20c245963c65ea599#diff-639834f1e05afe2276a86372adf0fe5f69314642c2d93cfa543d614ce5a76688).
