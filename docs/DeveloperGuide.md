...
**API:**
[`Storage.java`](https://github.com/migfoo02/tp/blob/master/src/main/java/seedu/application/storage/Storage.java)

### Common Classes

Classes used by multiple components are in the `seedu.applications.commons` package.
