...
* 1b. User includes more details about the contact in the request.
    ...
    * 1b1. NetworkBook adds a contact with all included details. 
...
4.  AddressBook adds a new phone number to the contact's list of phone numbers.
...
* 3b. User does not give a phone number.
    ...
    * 3b1. AddressBook shows an error message.
      ...
      Use case resumes at step 2.
* 3c. The given phone number is in an invalid format (has no country code).
