...
3. JABPro displays the list of persons to the user. 
...
5. The sorted or unsorted list is displayed t the user in ascending order based on the specified attribute.   
Use case ends.
