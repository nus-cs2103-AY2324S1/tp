...
| `id/` | Identification Number (IC) | `id/S2345678A` | `id/IC_NUMBER`           |
...
>:bulb: Use **h** as a shorcut for help.

>:bulb: Click on the Copy URL and paste the link in your preferred browser.
...
* Edits the patient with the specified name or IC.
* If an invalid name or IC is passed, an error message will be logged.
...
>:bulb: Use **f** as a shorcut for find.
...
>:bulb: Use **lo** as a shorcut for log.
...
>:bulb: Use **al** as a shorcut for alog.
...
>:bulb: Use **cl** as a shorcut for clog.
...
>:bulb: Use **d** as a shorcut for delete.
