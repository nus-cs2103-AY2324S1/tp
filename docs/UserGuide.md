...
| Tag not yet updated  | The tag does not exist, cannot attach a score to it | Ensure that the tag is updated first by doing `edit INDEX t/TAGNAME` before attaching a score to it.                                                | 
