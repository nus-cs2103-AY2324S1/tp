...
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------|
| `NAME`                | The name of the contact. <br/> <br/> It should only contain alphanumeric characters and spaces, and it should not be blank.                                                                                       | • `John Doe` <br> • `Miguel-James Lee`        |
| `PHONE`               | The phone number of the contact. <br/> <br/> It must contain only numbers, and be at least 3 digits long.                                                                                                         | • `999` <br> • `91243253`                     |
| `EMAIL`               | The email address of the contact. <br/> <br/> It must adhere to the format `[LOCAL-PART]@[SERVER].[DOMAIN]`.                                                                                                      | • `example@mail.com` <br> • `john@hotmail.sg` |
| `LAST_CONTACTED_TIME` | The last date and time you had a meeting with the contact. <br/> <br/> It must contain both date and time in the format `DD.MM.YYYY HHMM` or left blank.                                                          | • `29.10.2023 1000` <br> • `05.01.2023 2200`  |
| `STATUS`              | The status of the contact with regards to the insurance sales process. <br/> <br/> It must be one of `NIL, Prospective, Active, Inactive, Claimant, Renewal` (case-insensitive) or blank.                         | • `active` <br> • `Prospective`               |
| `REMARK`              | The remark you have about the contact, if any.                                                                                                                                                                    | • `has 4 cars` <br> • `Loves coffee`          |
| `TAG`                 | The tag you want to associate with the contact, if any. A contact can have more than 1 tag. <br/> <br/> It must be alphanumeric, i.e. special and non-alphanumeric characters (including spaces) are not allowed. | • `Friend` <br> • `TermLife`                  |
| `CONTACT_INDEX`       | The number shown beside each contact's name in the displayed contacts list. <br/> <br/> It must be a positive integer and not more than the total number of contacts.                                             | • `1`                                         |
