...
* **`check`**: Runs the code style check for both main and test code bases, then run all tests.
...
1. Update the version number in [`MainApp.java`](https://github.com/AY2324S1-CS2103T-T08-2/tp/blob/master/src/main/java/networkbook/MainApp.java).
